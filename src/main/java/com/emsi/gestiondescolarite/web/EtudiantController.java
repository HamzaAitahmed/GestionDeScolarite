...
public class EtudiantController {
    ...
    public String allSEtudiant(Model model,@ModelAttribute("connectedUser" ) User user ,
                              ...
                              @RequestParam(name="search", defaultValue = "") String searchName)
    {
        ...
        for(int i=0; i<pages.length; i++)
            pages[i]=i;
        long lenght = pageEtudiant.getTotalElements();
        ...
        return "Main/EtudiantPages/Etudiant";
    }
//
...
//    public String RegisterPage(Model model){ return "Register"; }
    ...
    public String createEtudiant(Model model,@ModelAttribute("connectedUser" ) User user) {
        ...
        return "Main/EtudiantPages/formAddEtudiant";
    }

    @GetMapping(path="/LoginEtudiant")
    public String LoginEtudiant(Model model,@ModelAttribute("connectedUser" ) User user ,
    ...
    public String RegitserEtudiant(Model model,@ModelAttribute("connectedUser" ) User user ,
                               @RequestParam(name = "email" ,defaultValue = "") String email,
    ...
    public String editEtudiant(Model model ,@ModelAttribute("connectedUser" ) User user ,int page, int size, String search, Integer id  )
    {
        ...
        return "Main/EtudiantPages/formEditEtudiant";
    }
}